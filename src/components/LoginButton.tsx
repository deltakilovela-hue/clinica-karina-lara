...
export default function LoginButton() {
  ...
  return (
    <button
      onClick={handleLogin}
      className="flex items-center justify-center gap-3 px-8 py-3 rounded-xl font-medium text-sm transition-all duration-200 hover:opacity-90 hover:scale-105"
      style={{
